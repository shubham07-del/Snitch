      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-neutral-900/80 border border-neutral-800/60 rounded-2xl p-5">
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {/* Full Name */}
            <div>
              <label htmlFor="fullname" className="block text-xs font-medium text-zinc-400 mb-1">
                Full Name
              </label>
              <input
                id="fullname"
            ...
            {/* Contact */}
            <div>
              <label htmlFor="contact" className="block text-[11px] font-medium text-neutral-500 uppercase tracking-wider mb-1">
                Contact Number
              </label>
              <input
                id="contact"
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {form.isSeller && (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="black" className="w-3.5 h-3.5">
