          ...
          <div className="mt-10 px-4 sm:px-0 lg:mt-0 lg:max-w-xl lg:col-span-1">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <button  onClick={()=>{
                ...
                navigate("/checkout",{state:{productId:productId, variantId: activeVariant._id}})
              }} className="flex cursor-pointer w-full flex-1 items-center justify-center rounded-md border border-gray-300 bg-white px-8 py-3 text-base font-medium text-gray-900 transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-50">
                Buy now
              </button>
            </div>
